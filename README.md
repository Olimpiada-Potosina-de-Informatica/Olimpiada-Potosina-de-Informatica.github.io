...
- [Correo electrónico](mailto:comite.opi@gmail.com "Mandar correo").
...
[Karelotitlán](http://www.cmirg.com/karelotitlan/Pantallas/Inicio.aspx "Karelotitlán") es una plataforma que tiene una enorme y muy bien hecha colección de problemas de Karel el robot en la pestaña de "[Problemas Karel](http://www.cmirg.com/karelotitlan/Pantallas/ListaProblemas.aspx "Problemas de Karel en Karelotitlán")", desde los más sencillos en la sección *Introducción* para irse habituando con el lenguaje, los *Básicos* para ir poniendo en práctica los conceptos principales, *Recursión* para empezar con la siguiente etapa de dificultad, *Recursión con parámetros* que es un nivel más alto todavía y finalmente *Búsquedas*. 

Al final está la sección de problemario que abarca una gran diversidad de problemas no clasificados para no tener un *spoiler* de las herramientas que se recomienda utilizar para resolver cada problema. Una guía más completa de como utilizar la plataforma de Karelotitlán se encuentra en [este vínculo](https://www.include-poetry.com/Code/Problemas/Karelotitlan/ "Guía de Karelotitlán - #iP").
...
Al final de cada artículo (en el pie del documento) hay un menú para ir al tema anterior o al tema siguiente. También puede valerse del [buscador del sitio](https://www.include-poetry.com/Code/Buscador/ "Buscador - #iP Code") para dar seguimiento a algún concepto o función.
...
Un libro que ningún participante y aspirante a la Olimpiada Mexicana de Informática se puede perder, este libro se encuentra de forma gratuita en la página oficial de [omegaup](https://omegaup.com "omegaUp"), lo puedes descargar en directo desde [este vínculo](https://omegaup.com/img/libropre3.pdf "Problemas y Algoritmos").
...
- Búsquedas
    + Concepto de búsqueda - [En #iP](https://www.include-poetry.com/Code/C++/Metodos/Busquedas/ "Concepto de búsqueda - #iP")
    + Búsquedas en Karel
